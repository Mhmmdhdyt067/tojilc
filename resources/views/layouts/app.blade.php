                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                        ...
                        <ul class="menu-nav">
                            ...
                            <li class="menu-item menu-item{{ Request::is('tryout*') ? '-active' : '' }}" aria-haspopup="true">
                                <a href="/tryout" class="menu-link">
                                    <span class="svg-icon menu-icon">
                                    ...
                                    <span class="menu-text">Try Out</span>
                                </a>
                            </li>
                            <li class="menu-item menu-item{{ Request::is('produk*') ? '-active' : '' }}" aria-haspopup="true">
                        ...
                        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex align-items-center flex-wrap mr-1">
                                ...
                                <div class="d-flex align-items-baseline mr-5">
                                    <!--begin::Page Title-->
                                    <h5 class="text-dark font-weight-bold my-2 mr-5">KELAS KEDINASAN</h5>
                                    <!--end::Page Title-->
                                    <!--begin::Breadcrumb-->
                                    <!--end::Breadcrumb-->
                                </div>
